	Feature: 6thstreet.com - Guest User Place Order Scenarios
	                         Guest User Place Order via COD and Admin Cancels the order
	
	
	@Smoke
	Scenario Outline: TS_GuestCheckout_01 - Guest User of 6thstreet.com site should be able to place order using TabbyPayInInstallments 
	...
	Scenario Outline: TS_RegisteredCheckout_03 - Registered User of 6thstreet.com site should be able to place order using cod
