...
@CucumberOptions(strict = true, monochrome = true, features = "src/test/resources/features/CardPayment.feature", glue = "stepdefinition", format = {
		"pretty", "json:target/cucumber.json" }, tags = { "@CreditCardPayment,@Smoke" }, plugin = {
