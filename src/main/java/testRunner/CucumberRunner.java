...
glue = "stepdefinition", format = {	"pretty" }, tags = { "@Footer","@run" },
plugin = {"com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-extent-reports/extent-report.html",
